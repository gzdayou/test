...
//布局换色设置
    ...
    $('.nav-tabs').each(function(){
        $(this).find('dl > dt > a').each(function(i){
            $(this).parent().next().css('top', (-155)*i + 'px');
            $(this).click(function(){

                $(".admincp-container-left").removeClass("newleft");
                $(".admincp-container-right").removeClass("newright");
    ...
    $('.nc-module-menu').find('a').click(function(){
        ...
        if( _modules == 'system' ) {
            ...
            //_url = $(this).parent().addClass('active').attr('data-url');
            //window.location.href = _url ;
            $(".admincp-container-left").addClass("newleft");
            $(".admincp-container-right").addClass("newright");
            $('#workspace').attr('src', ADMIN_SITE_URL + '/modules/' + _modules + '/index.php');
        }
    });
