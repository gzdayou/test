...
function update_flex(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=index&op=get_part_xml',
        colModel : [
            {display: '日期', name : 'date', width : 250, sortable : false, align: 'center'},
            {display: '冷冻水供水温度', name : 'collum1',  width : 100, sortable : false, align: 'center'},
            {display: '冷冻水回水温度', name : 'collum1', width : 150, sortable : false, align: 'center'},
            {display: '冷却水供水温度', name : 'collum2',  width : 200, sortable : false, align: 'center'},
            {display: '冷却水回水温度', name : 'collum3',  width : 300, sortable : false, align: 'center'}
            ],
        buttons : [
