    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="model_name" name="model_name" placeholder="请输入模式名" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div>
            ...
            <ul id="device_<?php echo $type;?>">
                ...
                ?>
                <li>
                    <input type="checkbox" name="<?php echo $type;?>[]" value="<?php echo $val['TagName'];?>" title="<?php echo $val['DeviceName'];?>">
                </li>
                <?php } ?>
            </ul>
            <?php } ?>
        ...
        <div class="btn_line">
            ...
            <button class="layui-btn layui-btn-danger layui-btn-radius" type="reset" >清空</button>
        </div>
...
function save() {
    ...
    $.ajax({
        type: 'post',
        url: 'index.php?act=schedule&op=add_template_ajax',
        data: formData,
