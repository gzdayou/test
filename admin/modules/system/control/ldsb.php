...
class ldsbControl extends SystemControl{
    private $links = array(
        array('url'=>'act=ldsb&op=index', 'text' => '一号泵'),
        array('url'=>'act=ldsb&op=idx_two', 'text' => '二号泵'),
        array('url'=>'act=ldsb&op=idx_three', 'text' => '三号泵'),
    );
