...
<div class="admincp-map ui-widget-content" nctype="map_nav" style="display:none;" id="draggable" >
  ...
  <script>
  //改变ifram属性
  function change_ifr_attr(attr, val) {
      $('iframe').attr(attr, val);
  }
//固定层移动
$(function(){
	//管理显示与隐藏
...
<div class="admincp-header">
  ...
  <div class="admincp-name">
      ...
      <h2>
          <img src="<?php echo ADMIN_SITE_URL?>/resource/image/logo.png" width="190" >
      </h2>
...
<div class="admincp-container unfold">
  <div class="admincp-container-left">
    ...
    <!-- <div class="about"><i class="fa fa-copyright"></i><span>国网湖南</span></div> -->
  </div>
  <div class="admincp-container-right">
    <div class="top-border"></div>
    <iframe src="" id="workspace" name="workspace" style="overflow: visible;" frameborder="0" width="100%" height="100%" scrolling="no" onload="window.parent"></iframe>
  </div>
</div>

<!--<div id="admin-footer">
    <i class="fa fa-copyright"></i>湖南国网版权所有
</div>-->
