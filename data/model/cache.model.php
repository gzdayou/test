...
class cacheModel extends Model {
    ...
    private function _admin_menu() {
        ...
        if (file_exists(BASE_PATH.DS.'/modules/analytics/include/menu.php')) {
            require(BASE_PATH.DS.'/modules/analytics/include/menu.php');
        }
        if (file_exists(BASE_PATH.DS.'/modules/alarm/include/menu.php')) {
            require(BASE_PATH.DS.'/modules/alarm/include/menu.php');
        }
        if (file_exists(BASE_PATH.DS.'/modules/repair/include/menu.php')) {
            require(BASE_PATH.DS.'/modules/repair/include/menu.php');
        }
        if (file_exists(BASE_PATH.DS.'/modules/logs/include/menu.php')) {
            require(BASE_PATH.DS.'/modules/logs/include/menu.php');
        }
        // if (file_exists(BASE_PATH.DS.'/modules/reports/include/menu.php')) {
        //     require(BASE_PATH.DS.'/modules/reports/include/menu.php');
        // }
        if (file_exists(BASE_PATH.DS.'/modules/users/include/menu.php')) {
            require(BASE_PATH.DS.'/modules/users/include/menu.php');
        }
        //unset($_menu['system']['child'][0]['child']['device_control']);
